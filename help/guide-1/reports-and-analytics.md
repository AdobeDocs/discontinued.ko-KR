...
2015년 Analysis Workspace이 출시된 이후 Reports &amp; Analytics 기능이 Analysis Workspace으로 이전되면서 워크플로 패리티의 한계점에 도달했습니다. [이 서비스 종료 공지](https://new.express.adobe.com/webpage/WFCyq7w8kijmB?)에서는 서비스 종료 프로세스에 대해 설명합니다.
