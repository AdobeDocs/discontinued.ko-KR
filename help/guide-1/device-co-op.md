---
keywords: device co-op;Device Co-op;수명 종료
...
이 문서에서는 CX Enterprise Device Co-op EOL(End-of-Life) 계획에 대해 자주 묻는 질문에 대한 답변을 제공합니다. 이 플랜이 적용되면 Adobe은 [CX Enterprise 중앙 릴리스 정보](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) 및 [우선 순위 제품 업데이트](https://www.adobe.com/kr/subscription/priority-product-update.html)에 고급 알림을 제공합니다.
...
- [[!DNL Adobe Advertising]](https://experienceleague.adobe.com/docs/advertising.html?lang=ko)
...
[!DNL Audience Manager] 및 [!DNL Advertising] 사용자의 경우, [!DNL Device Co-op] 데이터를 서드파티 그래프로 전송할 수 없습니다. [!DNL Device Co-op] 데이터는 [!DNL Device Co-op]를 필드 기반 결합으로 전환하는 CDA를 사용하여 [!DNL Analytics Ultimate] 사용자에 대해서만 마이그레이션됩니다. 그 밖의 솔루션에서는 데이터가 마이그레이션되지 않습니다.

## 다른 기능을 채택해야 합니까?

다른 Adobe 기능을 반드시 채택해야 하는 것은 아니지만, [!DNL Device Co-op] 사용 중지 전에 시간과 적절한 조정을 위해 가능한 한 빨리 다른 기능의 구현하는 것이 좋습니다.
