...
이 서비스 종료에는 `mobilemarketing.adobe.com`의 독립 실행형 플랫폼인 Adobe Mobile Services만 포함됩니다. 이 인터페이스를 사용하는 Mobile 버전 4 SDK는 2021년 8월 31일에 종료되었습니다.
...
Adobe이 모바일 마케팅 기능을 지속적으로 확장함에 따라 이전에 Mobile Services에서 사용할 수 있었던 기능은 CX 엔터프라이즈 솔루션에 출시되거나 Adobe Exchange 프리미어 파트너를 통해 제공될 예정입니다. 이러한 전환을 통해 더욱 강력하고 유연한 모바일 마케팅 기능이 제공될 예정입니다.
