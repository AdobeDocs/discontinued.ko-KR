...
[!DNL Adobe Experience Platform Auditor]은(는) [!DNL Adobe Experience Cloud] 구현의 등급을 매기고 개선 방법에 대한 지침을 제공하는 보고서를 생성할 수 있도록 해 주는 시스템이었습니다. [!DNL Adobe Experience Platform Auditor] 이(가) 서비스 종료(EOL)되었으며 더 이상 활성화되지 않습니다.
